...
def handle_customer():
    ...
    from_city = input("Please select the city you want to ride from: ")
    to_city = input("Please select the city you want to go to: ")
    ...
    if price is not None:
        ...
        print(f"The price is: {int(price)} liras.")
    else:
...
def handle_driver(trips_linked_list):
    ...
    conditions = input("If you have conditions like smoking or anything else, please specify: ")
...
def main():
    ...
    while True:
        role = input("Are you a customer or driver? ")
